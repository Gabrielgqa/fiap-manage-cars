...
@Module({
  ...
  controllers: [CreateAccountController, AuthenticateController, CreateCarController, GetListCarsController, GetUnsoldCarsController, UpdateSoldCarController, DeleteCarController],
